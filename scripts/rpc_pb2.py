...
_HOP = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='tlv_records', file=DESCRIPTOR),
  ],
  extensions=[
  ],
...
Hop = _reflection.GeneratedProtocolMessageType('Hop', (_message.Message,), {
  ...
  'TlvRecordsEntry' : _reflection.GeneratedProtocolMessageType('TlvRecordsEntry', (_message.Message,), {
...
_QUERYROUTESREQUEST_DESTTLVENTRY._options = None
_QUERYROUTESREQUEST.fields_by_name['ignored_edges']._options = None
_HOP_TLVRECORDSENTRY._options = None
